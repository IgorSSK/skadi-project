import { PutCommand as AwsPutCommand, type PutCommandInput } from "@aws-sdk/lib-dynamodb";
import type { DynamoDBDocumentClient } from "@aws-sdk/lib-dynamodb";
import { AbstractCommand, type CommandOptions, type IConditionalCommand } from "../core/commands.js";
	...
	implements IConditionalCommand<void>
{
	 ...
	 */
	public withCondition(expression: string, values?: Record<string, unknown>, names?: Record<string, string>): this {
	...
	public withConditionNotExists(attributeName: keyof T): this {
		...
		return this.withCondition(`attribute_not_exists(${placeholder})`, undefined, {
	 ...
	 */
	public withReturnItemCollectionMetrics(level: "SIZE" | "NONE" = "NONE"): this {
	...
	protected validateParameters(): void {
		if (!this.item) {
			throw new DynamoValidationError("PutCommand requires a valid item", undefined, "object", this.item);
		}
		...
		for (const requiredKey of requiredKeys) {
			if (!providedKeys.includes(requiredKey) || this.item[requiredKey] == null) {
				throw new DynamoValidationError(
