 ...
 */
export type Attribute<T = unknown> = PrimaryKeyAttribute<T> | StandardAttribute<T>;
 ...
 */
export type ExtractPrimaryKeys<TDef extends SchemaDefinition<Record<string, unknown>>> = {
 ...
 */
export type ExtractAllKeys<TDef extends SchemaDefinition<Record<string, unknown>>> = {
 ...
 */
export type UpdateExpression<TDef extends SchemaDefinition<Record<string, unknown>>> = Partial<
	Omit<ExtractAllKeys<TDef>, keyof ExtractPrimaryKeys<TDef>>
>;

/**
 * Query operation parameters with strong typing
 */
export interface QueryOptions<TDef extends SchemaDefinition<Record<string, unknown>>> {
	...
	readonly sortKey?: {
		readonly name: keyof ExtractPrimaryKeys<TDef>;
		readonly condition: "EQ" | "LT" | "LE" | "GT" | "GE" | "BEGINS_WITH" | "BETWEEN";
 ...
 */
export type CommandResult<TSuccess> = readonly [TSuccess, null] | readonly [null, Error];
