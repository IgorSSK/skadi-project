 ...
 */
export class StandardAttributeImpl<T>
  extends AbstractAttribute<T>
  implements StandardAttribute<T>
{
 ...
 */
export class PrimaryKeyAttributeImpl<T>
  extends AbstractAttribute<T>
  implements PrimaryKeyAttribute<T>
{
...
export const AttributeFactory = {
  ...
  string: (
    ...
    return new StandardAttributeImpl<string>(
      attrName,
      options.required,
      undefined,
      validate
  ...
  number: (
    ...
    return new StandardAttributeImpl<number>(
      attrName,
      options.required,
      undefined,
      validate
  ...
  date: (attrName?: string, required = false): StandardAttributeImpl<Date> => {
    const transform = (value: unknown): Date => {
      ...
      throw new DynamoValidationError(
        `Cannot convert value to Date: ${value}`,
        attrName,
        'Date',
        value
      );
  ...
  partitionKey: <T = string>(
    ...
    return new PrimaryKeyAttributeImpl<T>(
      'HASH',
      attrName,
      template,
      true,
  ...
  array: <T>(
    ...
    return new StandardAttributeImpl<T[]>(
      attrName,
      options.required,
      undefined,
      validate
