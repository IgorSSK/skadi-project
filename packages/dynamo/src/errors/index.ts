...
export abstract class DynamoError extends Error {
	...
	constructor(message: string, context?: ErrorContext, code?: string, retryable = false) {
		super(message);
...
export class DynamoCommandError extends DynamoError {
	...
	constructor(operation: string, message: string, originalError: unknown, context?: ErrorContext) {
		const isRetryable = DynamoCommandError.isRetryableError(originalError);
		super(message, context, DynamoCommandError.extractErrorCode(originalError), isRetryable);
	 ...
	 */
	public static fromAWSError(operation: string, error: unknown, context?: ErrorContext): DynamoCommandError {
...
export class DynamoValidationError extends DynamoError {
	...
	constructor(message: string, field?: string, expectedType?: string, actualValue?: unknown, context?: ErrorContext) {
...
export class DynamoConnectionError extends DynamoError {
	...
	constructor(message: string, endpoint?: string, region?: string, context?: ErrorContext) {
